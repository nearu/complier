...
%token AND  ARRAY  ASSIGN  BEGINP  CASE CHAR COLON COMMA CONST DIV DO SYS_CON
...
%token READ REAL RECORD REPEAT RP SEMI STRING THEN TO TYPE UNEQUAL UNTIL VAR WHILE
...
field_decl : ID_list  COLON  type_decl  SEMI
simple_type_decl : SYS_TYPE  |  ID  |  LP  ID_list  RP  
...
var_decl : ID_list  COLON  type_decl  SEMI
...
term : term  MUL  factor  |  term  DIV  factor  |  term  DIV  factor
